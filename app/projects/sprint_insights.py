...
- When risk_indicators.scope.creep_detected is true, treat risk_indicators.scope.summary and drivers as the authoritative scope narrative. Cite semantic_expansions when requirement text grew even if story points did not move. Mention issues_added/removed, points_increased_events, new_dependencies, and deadlines_unchanged when present.
"""
