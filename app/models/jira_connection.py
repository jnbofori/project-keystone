...
class JiraConnection(Base):
    ...
    __table_args__ = (UniqueConstraint("organization_id", name="uq_jira_connection_organization"),)
    ...
    organization: Mapped["Organization"] = relationship(back_populates="jira_connection")
